...
zip ../update.zip -r ./META-INF/ ./system/  ./recovery  ./daliyuxin ./scatter.txt ./SEC_VER.txt ./type.txt 
else 
echo "have boot.img"
...
zip ../update.zip -r  ./META-INF/ ./system/  ./recovery ./boot.img  ./daliyuxin ./scatter.txt ./SEC_VER.txt ./type.txt
else
echo "have bootloader.fex"
cp ../user/ota/bootloader.fex ./
#sudo chgrp -R jerry  ./bootloader.fex
#sudo chown -R jerry ./bootloader.fex
zip ../update.zip -r ./META-INF/ ./system/  ./recovery ./boot.img ./bootloader.fex ./daliyuxin ./scatter.txt ./SEC_VER.txt ./type.txt
fi
fi
